...
import com.swifts.frame.modules.act.entity.Act;
...
import com.swifts.frame.modules.act.dao.ActDao;
import com.swifts.frame.modules.act.utils.ProcessDefCache;
...
//			e.setProcExecUrl(ActUtils.getProcExeUrl(task.getProcessDefinitionId()));
     ...
     * @return
     */
    public PageInfo<Act> historicList(int pageNum, int pageSize, Act act) {
        String userId = UserUtils.getUser().getLoginName();//ObjectUtils.toString(UserUtils.getUser().getId());
        ...
        PageInfo<Act> page = new PageInfo<>();
        // 查询列表
...
//					List<HistoricIdentityLink> il = historyService.getHistoricIdentityLinksForProcessInstance(procInsId);
     ...
     * @param category 流程分类
     */
    public PageInfo<Object[]> processList(int pageNum, int pageSize, String category) {
        /*
