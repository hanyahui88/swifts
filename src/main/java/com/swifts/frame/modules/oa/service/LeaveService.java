...
import com.swifts.frame.modules.oa.dao.LeaveDao;
...
public class LeaveService extends BaseService {
    ...
    public void save(Leave leave, Map<String, Object> variables) {
        ...
        logger.debug("start process of {key=" + ActUtils.PD_LEAVE[0] + ", bkey=" + businessKey + ", pid=" + processInstance.getId() + ", variables=" + variables + "}");
    }
