...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.swifts.frame.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.swifts.frame.modules.sys.entity.User(null, userId)))){
